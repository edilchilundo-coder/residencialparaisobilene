        ...
        <div className="container mx-auto px-6">
          ...
          <div className="mt-16">
            <div className="flex items-center gap-3 mb-6 justify-center">
              ...
              <h3 className="text-2xl font-bold text-foreground">Localização & Street View 360°</h3>
            </div>
            <div className="relative w-full aspect-video overflow-hidden shadow-2xl rounded-sm">
              <iframe
                src="https://www.google.com/maps/embed?pb=!4v1710412345678!6m8!1m7!1sCAoSLEFGMVFpcE9QZzVfXzVfXzVfXzVfXzVfXzVfXzVfXzVfXzVfXzVfXzVfXzVf!2m2!1d-25.2795538!2d33.2490682!3f0!4f0!5f0.7820865974627469"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Residencial Paraíso Bilene - Street View 360"
